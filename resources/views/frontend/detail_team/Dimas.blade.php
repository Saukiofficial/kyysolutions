        ...
        <section class="hero-section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <img src="{{ asset('frontend/img/detail-team/img-tools/dimas1.png') }}" class="img-fluid rounded-circle mb-3" alt="Profile">
                    </div>
                   <div class="col-md-8">
    <h1 class="display-4" style="color: white; font-weight: bold;">GAME DEVELOPMENT</h1>
    <h2 style="color: white; font-weight: bold;">DIMAS ARDIANSYAH</h2>
    <p class="lead" style="color: white; font-weight: bold;">"GAME DEVELOPMENT"</p>
</div>
                </div>
            </div>
        </section>
        ...
        <section class="dark-section">
            <div class="container">
                ...
                <div class="experience-card">
                    <p>Saya Dimas Ardiansyah, seorang fresh graduate dari program studi Informatika, Universitas Trunojoyo Madura. Saya memiliki keahlian di bidang pengembangan game edukasi dan media pembelajaran interaktif. Dengan pemahaman yang mendalam tentang teknologi dan desain, saya berkomitmen untuk menciptakan solusi inovatif yang mendukung proses pembelajaran yang efektif dan menyenangkan</p>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="d-flex flex-wrap justify-content-center">
                            ...
                            <img src="{{ asset('frontend/img/detail-team/img-tools/c.png') }}" class="language-icon" alt="CSS">
                        </div>
                    </div>
                </div>
            </div>
