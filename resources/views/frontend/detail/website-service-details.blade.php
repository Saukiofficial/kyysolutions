  ...
  <main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Service Web Design Details</h1>
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="service-box">
              ...
              <div class="services-list">
                <a href="{{ route ('website-service-details') }}" class="active"><i class="bi bi-arrow-right-circle"></i><span>Web Design</span></a>
            ...
            <div class="help-box d-flex flex-column justify-content-center align-items-center">
              ...
              <p class="d-flex align-items-center mt-1 mb-0"><i class="bi bi-envelope me-2"></i> <a href="mailto:kyysolutions17@gmail.com">kyysolutions17@gmail.com</a></p>
            </div>
          ...
          <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
            <video autoplay width="100%" height="auto" controls>
                <source src="frontend/img/detail/website.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <h3>Jadikan Website Anda Wajah Digital Terbaik dengan Layanan dari KySolutions</h3>
            <p>
             KySolutions unggul dalam menghadirkan solusi website profesional yang dirancang khusus untuk memenuhi kebutuhan bisnis Anda. Kami percaya bahwa sebuah website bukan hanya sekadar tampilan online, tetapi juga representasi digital dari merek Anda. Oleh karena itu, kami memastikan setiap website yang kami buat memiliki standar kualitas terbaik.
            </p><br>
            <b>Layanan Pembuatan Website Kami: </b>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Desain Unik dan Responsif: Setiap website dirancang secara khusus agar responsif di semua perangkat, mulai dari komputer hingga ponsel. Dengan desain yang menarik, kami memastikan pengunjung Anda memiliki pengalaman yang menyenangkan.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Optimasi SEO Terbaik: Website Anda akan dioptimalkan untuk mesin pencari sehingga mudah ditemukan di Google dan meningkatkan visibilitas bisnis Anda.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Fitur Lengkap: Kami menyediakan berbagai fitur seperti sistem pembayaran, integrasi media sosial, formulir kontak, dan lainnya yang dapat disesuaikan dengan kebutuhan Anda.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Keamanan Terjamin: Kami menggunakan protokol keamanan terkini untuk melindungi data Anda dari ancaman siber.</span></li>
            </ul>
            <p>
            <b>Kenapa Anda Membutuhkan Website Profesional?</b><br><br>
            Website adalah wajah bisnis Anda di dunia digital. Dengan memiliki website yang profesional, Anda dapat meningkatkan kredibilitas, menjangkau lebih banyak pelanggan, dan menciptakan kesan pertama yang positif. Dengan KySolutions, Anda mendapatkan semua itu dengan kualitas yang tidak tertandingi.
            </p>
          </div>
