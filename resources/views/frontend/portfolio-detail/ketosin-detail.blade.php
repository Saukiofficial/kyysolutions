...
<head>
  ...
  <title>Portfolio Details - KyySolutions </title>
  ...
  <main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Portfolio Details-Pemilihan Ketua Osis (Ketosin)</h1>
        ...
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide">
              <img src="{{ asset ('frontend/img/portfolio-detail/ketosin/ketosin-utama.png') }}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{ asset ('frontend/img/portfolio-detail/ketosin/ketosin-login.png') }}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{ asset ('frontend/img/portfolio-detail/ketosin/ketosin-dashboard.png') }}" alt="">
            </div>
            <div class="swiper-slide">
                <img src="{{ asset ('frontend/img/portfolio-detail/ketosin/ketosin-kandidat.png') }}" alt="">
              </div>
          </div>
