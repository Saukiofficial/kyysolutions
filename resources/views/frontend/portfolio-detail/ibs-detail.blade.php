  ...
  <main class="main">
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Portfolio Details-inventaris barang sekolah</h1>
        ...
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide">
              <img src="{{ asset ('frontend/img/portfolio-detail/ibs/ibs-utama.png') }}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{ asset ('frontend/img/portfolio-detail/ibs/ibs-login.png') }}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{ asset ('frontend/img/portfolio-detail/ibs/ibs-dashbord-super-admin.png') }}" alt="">
            </div>
          </div>
